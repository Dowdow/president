...
export default function GameHeader({ gameId, gameStarted, handleStartGame, handleLeaveGame }: GameHeaderProps) {
  ...
  return (
    <div className="flex justify-between items-center p-5 bg-skin-gradient">
      ...
      <div className="flex gap-5">
        {!gameStarted ? (
          <button type="button" className="game-button" onClick={handleStartGame}>
            Start Game
          </button>
        ) : (
          ""
